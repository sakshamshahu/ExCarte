...
const Onboarding: React.FC<OnboardingProps> = ({ onComplete }) => {
  ...
  const handleSubmit = async () => {
    ...
    try {
      // Create user profile
      const userData = await api.auth.createProfileWithPreferences(
        {
          auth_id: user.id,
          ...
          >
              ...
              <div>
                ...
                <div className="mt-6 space-y-4">
                    ...
                    <div className="flex items-center">
                      ...
                      <div className="ml-3">
                        ...
                        <p className="text-sm text-gray-500">
                          I prefer cafes, shopping, and daytime activities
                        </p>
                      </div>
                    </div>
                  </div>
                  ...
                  >
                    <div className="flex items-center">
                      ...
                      <div className="ml-3">
                        ...
                        <p className="text-sm text-gray-500">
                          I prefer nightlife, dining, and evening activities
                        </p>
                      </div>
                    </div>
                  </div>
                  ...
                  <div
                    ...
                    onClick={() =>
                      setFormData((prev) => ({ ...prev, explorerType: "both" }))
                    }
                  >
                    <div className="flex items-center">
                      <div className="flex">
                      ...
                      <div className="ml-3">
                        ...
                        <p className="text-sm text-gray-500">
                          I enjoy exploring at any time of day
                        </p>
                      </div>
                    </div>
                  </div>
            ...
            {step === 2 && (
              <div>
                ...
                <p className="mt-2 text-gray-600">
                  Rate your interest in each category from 1 to 5.
                </p>
